      ...
      <div class="card-body">
        ...
        <div class="event border-bottom py-3">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="image-grouped ml-auto">
              <img src="{{asset('back_end/assets/images/faces/face10.jpg')}}" alt="profile image">
              <img src="back_end/assets/images/faces/face13.jpg" alt="profile image"> </div>
          </div>
        </div>
        <div class="event py-3 border-bottom">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="image-grouped ml-auto">
              <img src="back_end/assets/images/faces/face20.jpg" alt="profile image">
              <img src="back_end/assets/images/faces/face17.jpg" alt="profile image">
              <img src="back_end/assets/images/faces/face14.jpg" alt="profile image"> </div>
          </div>
        </div>
        <div class="event py-3">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="image-grouped ml-auto">
              <img src="back_end/assets/images/faces/face21.jpg" alt="profile image">
              <img src="back_end/assets/images/faces/face16.jpg" alt="profile image"> </div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="fluid-container">
          <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{asset('back_end/assets/images/faces/face1.jpg')}}" alt="profile image"> </div>
          ...
          <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{asset('back_end/assets/images/faces/face2.jpg')}}" alt="profile image"> </div>
            <div class="ticket-details col-md-9">
              <div class="d-flex">
          ...
          <div class="row ticket-card mt-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{asset('back_end/assets/images/faces/face3.jpg')}}" alt="profile image"> </div>
            <div class="ticket-details col-md-9">
              <div class="d-flex">
