...
<!-- endinject -->
<!-- Layout styles -->
<link rel="stylesheet" href="{{asset('back_end/assets/css/demo_1/style.css')}}">
<!-- End Layout styles -->
<link rel="shortcut icon" href="{{asset('back_end/assets/images/favicon.png')}}">
<link rel="shortcut icon" href="{{asset('back_end/assets/sweet/css/extensions/sweetalert2.min.css')}}">

<link rel="shortcut icon" href="{{asset('back_end/assets/sweet/css/extensions/toastr.css')}}">
<link rel="shortcut icon" href="{{asset('back_end/assets/sweet/css/toastr/extensions/toastr.min.css')}}">

<link rel="stylesheet" href="{{asset('back_end/my_assets/css/custom.css')}}">
