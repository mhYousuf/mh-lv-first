        ...
        <div class="form-group">
            <div class="dropdownx">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" id="" href="{{ url('admin/about/form') }}" >&nbsp; Add new</a>
                </div>
            </div>
        </div>
    </div>
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <!--  <td>
                  ...
                  <td align="center">
                    <a class="btn btn-icons btn-rounded btn-success" href="{{ url('admin/about/form/'.$v->id) }}" id="{{ $v->id }}">
                        <i class="mdi mdi-plus"></i>
                    </a>
                    <button class="btn btn-icons btn-rounded btn-danger del_btn" data-href="{{ url('admin/about/destroy/'.$v->id) }}" data-id="{{ $v->id }}" ><i class="mdi mdi-delete"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
