            ...
            <table id="order-listing" class="table dataTable no-footer">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="left"> <img src="{{url('back_end/upload/details/'.$v->image)}}" style="height: 60px !important; width: 80px !important; "></td>
                  <!-- <td><img src="{{url('back_end/upload/basic/'.$v->footer_logo)}}" style="height: 60px !important; width: 80px !important; "></td> -->
                  <td align="left">{{ substr($v->description, 0, 10) }}....</td>
