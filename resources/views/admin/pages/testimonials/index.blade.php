        ...
        <div class="form-group">
            <div class="dropdownx">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" id="" href="{{ url('testimonial/create/form') }}" >&nbsp; Add new</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <table id="order-listing" class="table dataTable no-footer">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center">
                    <a class="btn btn-icons btn-rounded btn-success" href="{{ url('testimonial/create/form/'.$v->id) }}" id="{{ $v->id }}">
                        <i class="mdi mdi-plus"></i>
                    </a>
                    <button class="btn btn-icons btn-rounded btn-danger del_btn" data-href="{{ url('testimonial/destroy/'.$v->id) }}" data-id="{{ $v->id }}" ><i class="mdi mdi-delete"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
